// Filename: views/components/componentSlaveView.js
/*
  ...
  return Backbone.View.extend({
    ...
    */
    initialize: function(options){
      ...
      dispatch.on('triggerSlave.event', this.updateModel, this);
      this.render({representation: 'linear-bar-svg'});
    },
    ...
    render: function(options){
      if(options) {
        new MeasuresView({
          ...
          el:'#component'+this.component.cid + this.slaveNo,
          newMeasureRepresentation: options.representation,
          slaveNo: this.slaveNo
        });

        new FractionRepresentationView({
          collection:this.component.get('measures'),
          parent: this.component,
          el:'#fraction'+this.component.cid + this.slaveNo,
